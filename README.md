...
## Contributors
 - **Nathaniel Kisakye** — Designed and implemented the full system architecture, SLAM pipeline (Karto), and ROS navigation stack integration
- **Samuel Ametefe** — Designed and implemented the A* pathfinding algorithm, enabling shortest-path navigation using occupancy grids generated by the SLAM pipeline
