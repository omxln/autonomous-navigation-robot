...
- **Samuel Ametefe** — Developed the A pathfinding algorithm*, enabling the robot to perform shortest-path navigation using the occupancy grids generated by the SLAM pipeline.
